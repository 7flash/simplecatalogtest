...
jQuery (document).ready (function ($) {
	...
	$('.js-sc-select-url').click(
		function() {
			window.location.href = $(this).data('sort-asc');
		}
	);

	$('.js-change-sort').click(function() {
		var url = '';
		if($(this).data('order') == 'desc'){
			url = $('.active .js-sc-select-url').data('sort-asc');
		}else{
			url = $('.active .js-sc-select-url').data('sort-desc');
