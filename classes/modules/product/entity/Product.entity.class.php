...
/*		array('add_date', 'date', 'format' => array('yyyy-MM-dd hh:mm:ss'), 'allowEmpty' => false),
	...
	protected $aRelations = array(
		 ...
		 */
		'fields' => array(EntityORM::RELATION_TYPE_HAS_MANY, 'PluginSimplecatalog_ModuleProduct_EntityFields', 'product_id'),
	...
	public function getProductFields($aExcludeFieldsByCodes = array()) {
		 ...
		 */
		if (!$this->aProductFields) {
			$this->aProductFields = $this->getFields();
		}
		/*
	...
	public function getItemShowWebPathDir() {
		return '/' . $this->getScheme()->getSchemeUrl() . '/' . $this->getProductUrl();
	}
