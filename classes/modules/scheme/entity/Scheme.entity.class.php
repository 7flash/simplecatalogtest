...
class PluginSimplecatalog_ModuleScheme_EntityScheme extends EntityORM {
	...
	protected $aRelations = array(
		 ...
		 */
		'scheme_fields' => array(EntityORM::RELATION_TYPE_HAS_MANY, 'PluginSimplecatalog_ModuleScheme_EntityFields', 'scheme_id'),
	...
	public function getFields($aExcludeFieldsByCodes = array()) {
		 ...
		 */
		if (!$this->aSchemeFields ) {
			$this->aSchemeFields = $this->getSchemeFields();
		}
		/*
