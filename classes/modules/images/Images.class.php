...
class PluginSimplecatalog_ModuleImages extends ModuleORM {
	 ...
	 */
	public function GetImageWithSize($sFile, $iWidth, $iHeight, $bExactProportions = true, $sDir = null, $bRemoveOriginal = true) {
		/*
		 ...
		 */
		$bSuccess = $this->CreateResizedImageWithSavedProportion($sFile, $sFileNew, $iWidth, $iHeight, $bExactProportions);
		/*
		 ...
		 */
		return ($bSuccess ? $this->PluginSimplecatalog_Tools_GetWebPath($sFileNew) : false);
	}
